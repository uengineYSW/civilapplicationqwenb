...
export default {
    ...
    data: () => ({
        ...
        urlPath: null,
        menus: [
            { id: 'applicationProcessing', title: '민원신청 프로세스',
                items: [
                    { key: 'applications', url: '/applications', name: '신청서' },
                ]
            },
            { id: 'dataCollection', title: '추가 정보 수집',
                items: [
                    { key: 'dataCollectors', url: '/dataCollectors', name: '데이터 수집기' },
                ]
            },
            { id: 'documentIssuance', title: '문서 발급',
                items: [
                    { key: 'pdfDocuments', url: '/pdfDocuments', name: 'PDF문서' },
                    { key: 'electronicSignatures', url: '/electronicSignatures', name: '전자서명' },
                ]
            },
        ],
        cards: [
